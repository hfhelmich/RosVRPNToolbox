function installRosVRPNToolbox(replaceExisting)
% INSTALLROSVRPNTOOLBOX installs RosVRPNToolbox for MATLAB.
...
%
%   INSTALLROSVRPNTOOLBOX(false) installs RosVRPNToolbox only if no copy 
%   of the RosVRPNToolbox exists in the MATLAB root.
%
